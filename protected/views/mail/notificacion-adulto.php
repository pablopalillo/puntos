		...
		<tr>
			<td>
				...
				<table style="display: inline-table; margin:0 auto" border="0" cellpadding="0" cellspacing="0" width="500">
					...
					<p>Para participar en este juego fue necesario que él nos indicara el nombre de un adulto responsable que avalara su participación en dicho , y por eso te llega este mensaje. </p>
					<p>Si tienes alguna inquietud o estás en desacuerdo, puedes escribirnos a <a mailto="puntostm@telemedellin.tv"></a>contacto@puntos.telemedellin.tv</p>
					<p>Para mayor información visita <?php echo CHtml::link( Yii::app()->getBaseUrl(true),  Yii::app()->getBaseUrl(true) ); ?></p>
				</table>
				</center>
			</td>
		</tr>
